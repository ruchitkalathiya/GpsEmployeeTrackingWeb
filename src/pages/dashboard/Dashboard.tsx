...
import PopularDestination from '../../pages/homepage/popular-destination/PopularDestination';
import PopulatHost from '../../pages/homepage/popular-host/PopulatHost';
import Tourlist from '../../pages/homepage/tourcard/Tourlist';
...
// useState<Date | null>(new Date());
    ...
    const SignUp = async () => {
        ...
        let data = new FormData();
          ...
          data.append("userid", state.userName)
          data.append("email", state.email)
          data.append("phoneNumber", state.phoneNumber)
          data.append("password", state.password)
          data.append("countrynew", state.countrynew)
          data.append("gender", state.gender)
          data.append("bDay", state.bDay)
          data.append("bMonth", state.bMonth)
          data.append("bYear", state.bYear)
          data.append("employeerole", state.employeerole)
          data.append("employeeselery", state.employeeselery)
          data.append('fileData', fileima)
        ...
        setFormDataa(JSON.stringify(data))
        console.log('Data', data.get('firstName'));

        if(data){
            console.log("datannnnnnnnn",data);
            
            Axios.post("http://192.168.56.1:5000/api/auth/signup",data
            // {
            //   body: data,
            // }
            )
    ...
    // useEffect(() => {
    //     console.log('formData', formDataa.get('firstName'));
    // }, [formDataa])
                                         ...
                                         <Form>
                                             ...
                                             <Row>
                                                 ...
                                                 <Col md={6}>
                                                     <InputField
                                                         label="Upload Image"
                                                         fromrowStyleclass="mt-2 pt-md-3 pt-0"
                                                         name="photo"
                                                         value={state.photo}
                                             ...
                                             {/* <Row>
                                                 <Col className="mt-4">
                                                     ...
                                                     <Select
                                                         ...
                                                         name="countrynew"
                                                         value={state.countrynew}
                                                         placeholder={t('Select Employee Country')}
                                                         onChange={(e: any) => { handleChange(e) }}
                                                         theme={theme => ({
                                                             ...theme,
                                                             borderRadius: 0,
                                             ...
                                             <Row>
                                                 <Col className="mt-4">
                                                     ...
                                                     <Select
                                                         ...
                                                         select={state.gender}
                                                         name="gender"
                                                         placeholder={t('Select Employee Gender')}
                                                         onChange={(e: any) => setState({
                                                             ...state,
                                                             gender: e.value
                                                         })}
                                             ...
                                             <Row>
                                                 <Col className="mt-4">
                                                     <label className="label-input-style">{t('Select Role')}</label>
                                                     <Select
                                                         className={formError.genderError ? "css-e56m7-control danger-border" : "css-e56m7-control"}
                                                         options={roleoptions}
                                                         label=""
                                                         select={state.employeerole}
                                                         name="gender"
                                             ...
                                             <Row>
                                                 <Col>
                                                     <InputField
                                                         ...
                                                         fromrowStyleclass="mt-4"
                                                         name="employeeselery"
                                                         value={state.employeeselery}
                                                         placeholder={t('Enter Employee Salary')}
                                                         type="text"
                                                         InputstyleClass={formError.passwordError ? "custom-input mb-0 danger-border" : "custom-input mb-0"}
                                                         lablestyleClass="label-input-style"
                                                         onChange={(e: any) => { handleChange(e) }}
                                             ...
                                             <Row className="mt-4">
                                                 <Col>
                                                     <Buttons ButtonStyle="btn-customs w-100" onClick={SignUp}>{t('Add Employee')}</Buttons>
                                                 </Col>
                                             </Row>
                                             <Row className="py-3">
                                                 <Col >
                         ...
                         <Container className="form-hero-button">
                             <Row>
                                 <Col md={12} className="text-center">
                                     ...
                                     <Buttons ButtonStyle="btn-customs-transparent mr-md-2 btn-lg" onClick={() => { return setsignuppopup(true); }} >
                                         <FontAwesomeIcon icon={faUser} className="mr-1" /> <span>{t ('Add Employee')}</span>
                                     </Buttons>
